...
#
GTK_VERSION	:= 3.18.3
GTK_MD5		:= e172049e8c40ad03c4ac864b9a2e9bf4
GTK		:= gtk+-$(GTK_VERSION)
GTK_SUFFIX	:= tar.xz
GTK_URL		:= http://ftp.gtk.org/pub/gtk/$(basename $(GTK_VERSION))/$(GTK).$(GTK_SUFFIX)\
	http://ftp.gnome.org/pub/GNOME/sources/gtk+/$(basename $(GTK_VERSION))/$(GTK).$(GTK_SUFFIX)
...
#	ac_cv_path_CUPS_CONFIG=no \
	...
	HARFBUZZ_CFLAGS="-I$(SYSROOT)/usr/include" \
	HARFBUZZ_LIBS="-L$(SYSROOT)/usr/lib" \
	PANGO_CFLAGS="-I$(SYSROOT)/usr/include/pango-1.0/pango" \
	PANGO_LIBS="-L$(SYSROOT)/usr/lib" LIBS+="-lstdc++"
