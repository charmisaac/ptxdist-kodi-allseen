...
$(STATEDIR)/libgpg-error.compile:
	@$(call targetinfo)
	@cd $(LIBGPG_ERROR_DIR)/src/syscfg && \
		cp lock-obj-pub.aarch64-unknown-linux-gnu.h lock-obj-pub.linux-gnueabihf.h
	@$(call world/compile, LIBGPG_ERROR)
	@$(call touch)
