...
# Paths and names
#
HOST_SWIG_VERSION	:= 3.0.7
HOST_SWIG_MD5		:= 7fff46c84b8c630ede5b0f0827e3d90a
HOST_SWIG		:= swig-$(HOST_SWIG_VERSION)
HOST_SWIG_SUFFIX	:= tar.gz
HOST_SWIG_URL		:= $(call ptx/mirror, SF, swig/$(HOST_SWIG).$(HOST_SWIG_SUFFIX)) \
		http://prdownloads.sourceforge.net/swig/$(HOST_SWIG).$(HOST_SWIG_SUFFIX) \
		http://sourceforge.net/projects/swig/files/swig/$(HOST_SWIG)/$(HOST_SWIG).$(HOST_SWIG_SUFFIX)
