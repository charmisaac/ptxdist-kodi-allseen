...
# Paths and names
#
LIBASS_VERSION	:= 0.11.2
LIBASS_MD5	:= 701b761934de0eff7d45f58d7d13eaf6
LIBASS		:= libass-$(LIBASS_VERSION)
LIBASS_SUFFIX	:= tar.xz
LIBASS_URL	:= http://libass.googlecode.com/files/$(LIBASS).$(LIBASS_SUFFIX)	\
		https://github.com/libass/libass/releases/download/$(LIBASS_VERSION)/$(LIBASS).$(LIBASS_SUFFIX)
