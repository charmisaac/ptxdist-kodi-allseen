...
LIBCROCO_MD5		:= f1863da805c9206563da06f56da1ea55
LIBCROCO		:= libcroco-$(LIBCROCO_VERSION)
LIBCROCO_SUFFIX		:= tar.xz
LIBCROCO_URL		:= http://ftp.gnome.org/pub/GNOME/sources/libcroco/$(basename $(LIBCROCO_VERSION))/$(LIBCROCO).$(LIBCROCO_SUFFIX)
