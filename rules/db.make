...
ifdef PTXCONF_DB_61
DB_VERSION      := 6.1.26
DB_MD5          := 9525aa57a282d49e5d1bf5e48ffa8a56
endif
...
ifdef PTXCONF_DB_61
	@$(call install_copy, db, 0, 0, 0644, -, \
		/usr/lib/libdb-6.$(DB_MINOR).so)
	@$(call install_link, db, libdb-6.$(DB_MINOR).so, /usr/lib/libdb-6.so)
	@$(call install_link, db, libdb-6.$(DB_MINOR).so, /usr/lib/libdb.so)
else
	@$(call install_copy, db, 0, 0, 0644, -, \
